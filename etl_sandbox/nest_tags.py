...
def process_tags(form, tags, result, source):
    ...
    if source == 'declension':
        case_tags = CASES_TAGS.intersection(tags)

        if case_tags:
            process_case_tags(form, tags, result, derogatory)
        elif number_tags:
            process_number_tags(form, tags, result, derogatory)
        elif gender_tags:
            process_gender_tags(form, tags, result, derogatory)
        ...
        if tense_tags:
            ...
            process_person_tags(form, tags, result, derogatory)
        elif number_tags:
            process_number_tags(form, tags, result, derogatory)
        elif gender_tags:
            process_gender_tags(form, tags, result, derogatory)
...
def process_forms(forms):
    ...
    return result, invalid_forms, invalid_forms_percent
